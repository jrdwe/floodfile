...
the application does it's best to catch every packet but it's super unreliable. very small files have a higher chance of success. large files are **very** loud over the network.
